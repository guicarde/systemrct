...
if (isset($_SESSION['accion_cliente']) && $_SESSION['accion_cliente'] != '') {

    if ($_SESSION['accion_cliente'] == 'busqueda') {
        $clientes = $_SESSION['arreglo_buscado_cliente'];
    } else {
        ...
        <section class="content">
         ...
         <div class="row"> 
          <form class="form-horizontal" action="../Controles/Registro/CCliente.php" method="POST">
              <input type="hidden" id="hiddencliente" name="hidden_cliente" value="buscar"> 
           <div class="col-md-6">
              <!-- Horizontal Form -->
    ...
    foreach ($clientes as $c) {
        ?>
                      <tr>
                        ...
                        <td><?php echo $c['cliente_fecharegistro'] ?></td>
                        <td><?php if($c['cliente_estado']=='1') {?>
                                                        <form method='POST' id="formcli" action="../Controles/Registro/CCliente.php">
                                                            <input type="hidden" name="id_hidden_eliminar" value="<?php echo $c['cliente_idcliente'] ?>">
                                                            <input type="hidden" name="hidden_cliente" value="anular">
                        ...
                        <td>
                                                       <form method='POST' id="formcli" action="../Controles/Registro/CCliente.php">
                                                            <input type="hidden" name="hidden_cliente" value="buscarid">
                                                            <input type="hidden" name="idcli" value="<?php echo $c['cliente_idcliente'] ?>">
