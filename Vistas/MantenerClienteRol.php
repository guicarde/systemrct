...
if (isset($_SESSION['accion_rol']) && $_SESSION['accion_rol'] != '') {
    ...
    if ($_SESSION['accion_rol'] == 'busqueda') {
        $roles = $_SESSION['arreglo_buscado_rol'];
    } else {
        $roles = $rol->listar();
    }
} else {
        ...
        ?>
                      <tr>
                        ...
                        <td>
                                                        <?php
                                                        $cliente = new Cliente();
                                                        $clientes = $cliente->listar_por_rol($r['rol_idrol']);
                                                         ?>
                                                        <?php if ($clientes != null) { ?>
                                                        <?php foreach ($clientes as $c) {   
                                                                    ?>
                                                        <label class="checkbox-inline">
                                                        <input type="checkbox" id="inlineCheckbox<?php echo $c['clirol_idclirol']; ?>" name="check_list[]" checked disabled value="<?php echo $c['clirol_idclirol']; ?>"> <?php echo $c['cliente_nombre'];  ?>
                                                        </label><br>
                                                        
                                                        
                                                         <?php } ?>
                                                        <?php } else {?>
                                                        <div class="alert alert-danger"><i class="fa fa-warning"></i><b> Warning!</b><br>Not yet allocated<br>Client for <br>this role..!</div> 
                                                        <?php } ?>
                        </td>  
                        <td><?php echo date('d/m/Y', strtotime($r['rol_fecharegistro'])) ?></td>
                        <td>
                                                       <form method='POST' id="formusu" action="../Controles/Registro/CRol.php">
                                                            <input type="hidden" name="hidden_rol" value="buscarid">
                                                            <input type="hidden" name="idrol" value="<?php echo $r['rol_idrol'] ?>">
